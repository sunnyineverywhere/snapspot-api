package snap.auth.service;

import lombok.RequiredArgsConstructor;
import org.springframework.stereotype.Service;
import snap.auth.dto.request.KaKaoSignUpRequestDto;
import snap.auth.dto.request.KakaoSignInRequestDto;
import snap.auth.dto.request.SignInRequestDto;
import snap.auth.dto.request.SignUpRequestDto;
import snap.auth.dto.response.SignInResponseDto;
import snap.auth.dto.response.SignUpResponseDto;
import snap.member.entity.Member;
import snap.infrastructure.security.dto.KakaoRes;
...
import snap.infrastructure.security.service.KakaoOAuthService;
